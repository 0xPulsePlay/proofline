...
| Leg | Status |
| --- | --- |
| Solana mainnet adapter program | **REAL — DEPLOYED + on-chain verification proven**: [`PRF5wS3RSArKNCC2pYtDvBciM9KxtDw6tqAUzimKqbN`](https://explorer.solana.com/address/PRF5wS3RSArKNCC2pYtDvBciM9KxtDw6tqAUzimKqbN) executed [`verify_outcome`](https://explorer.solana.com/tx/39WXYxtkwURZ4vhL6ZiCtNJiqGrnjQFi78SohuwPqLS8RK9sD39vieCeHuQ94pSjjwBAXt4g91MQkwVNxDo6eh1K) as a real mainnet transaction — CPI into deployed TxLINE, Merkle proof verified against the real mainnet daily root, exact one-byte `true`, [VerifiedOutcome PDA](https://explorer.solana.com/address/7Lx6G4d7stCQxHQZ796STyTRCpZ4Yfq9852K23FatamV) with every field derived from the verified bytes. Wormhole emission is feature-gated OFF (unproven CPI stays out of the mainnet build) |
| Solana mainnet Memo attestation | **REAL** — [`5PTAqE8d…`](https://explorer.solana.com/tx/5PTAqE8dveY8opG8PAE7iFbkj9BrQJt4yDKEjXqFkDixeu5TGAHm45cXx1vXPGAWkobdNaQpL7JkJ1bUqwjWcp7E): compact digest-bound attestation, second-RPC byte-exact readback (this path is client-verified + memo-anchored — labeled distinctly from the on-chain path above) |
| Base **mainnet** contracts (all 5) | **REAL — deployed + exercised**: [L3 report](https://basescan.org/tx/0x85cbc2740836b13c8a372377c786c34a4d14cbd2bbe5ff978442af726d098581) → [VAA import](https://basescan.org/tx/0xbe0944a86a9c74b5ec1919a7813a344a0257aca9d18cf33e6326a63065c6284e) → on-chain DualFinalized → [settle()](https://basescan.org/tx/0x5b9c16cd139e9ea6250b44525bfe681f2f42d201c6e432899e26d2a81ed8f03d) |
